...
2. 下载 [启动固件](https://oem-share.canonical.com/partners/tangshan/share/ubuntu-server-24.04/20250912-127-repack/QLI.1.4-ubuntu-rubikpi3-nhlos-bins-20250912-127.tar.gz) 并将解压后的启动固件复制到 `rubikpi3_ubuntu_images` 文件夹中。
    :::note
    如果有 patch0.xml 文件，请从启动固件文件夹中删除它。
    :::

3. 从 [Canonical 网站](https://oem-share.canonical.com/partners/tangshan/share/ubuntu-server-24.04/20250912-127-repack/) 下载 `dtb.bin` 并复制到 rb3_ubuntu_images 文件夹中。

4. 从 [Canonical 网站](https://oem-share.canonical.com/partners/tangshan/share/ubuntu-server-24.04/20250912-127-repack/) 下载 `ubuntu-24.04-preinstalled-server-arm64+rubikpi3-20250912-127.img.xz`，解压缩包以获得原始镜像文件。
...
5. 将 Ubuntu原始映像 `ubuntu-24.04-preinstalled-server-arm64+rubikpi3-20250912-127.img` 文件复制到 `rubikpi3_Ubuntu_images` 文件夹。
    ...
    ```
6. 从 [Canonical 网站](https://oem-share.canonical.com/partners/tangshan/share/ubuntu-server-24.04/20250912-127-repack/) 下载 `rawprogram0.xml` 并复制到 `rubikpi3_ubuntu_images` 文件夹中。
