...
5. 若烧录后无法启动，您可以点击 [此处](https://thundercomm.s3.dualstack.ap-northeast-1.amazonaws.com/uploads/web/rubik-pi-3/firmware/Flat_usb_fw.zip) 下载 provision 文件重新对 UFS 进行配置。
...
3. 若烧录后无法启动，您可以点击 [此处](https://thundercomm.s3.dualstack.ap-northeast-1.amazonaws.com/uploads/web/rubik-pi-3/firmware/Flat_usb_fw.zip) 下载 provision 文件重新对 UFS 进行配置。
