...
### 关于风扇
  ...
  魔方派 3 不附赠风扇，在一些计算压力大的场景，推荐您购买和安装风扇以达到更好的运行效果。详见[支持配件清单](./1.快速入门/1.支持配件清单.md)。
...
### 如何刷写配置参数表 (CDT)？
  ...
  确保设备处于 EDL 模式。有关更多信息，请参阅 [进入 EDL 模式](./1.快速入门/2.更新软件.md#enterEDL)。
  :::
...
### 如何配置通用闪存存储 (UFS)？
  ...
  * 请参阅 [使用 QDL 工具进行刷写](1.快速入门/2.更新软件.md#flashQDL)。

### 如何将设备强制进入 EDL 模式？

  * 请参阅 [进入 EDL 模式](./1.快速入门/2.更新软件.md#enterEDL)。
...
### 如何使用 Minicom 来设置调试 UART？
  ...
  * 请参阅 [设置调试 UART](./1.快速入门/3.设置设备.md#setUART).
...
### 如何从桌面版本切换为服务版本
  ...
  1. 参见 [连接到网络](./1.快速入门/3.设置设备.md#conNET) , 确保网络连接状态正常。
